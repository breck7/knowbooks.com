const catalog = [
  {
    "id": "launch",
    "description": "Includes ticket to Knowbooks Oahu launch beachside celebration on a weekend day in October 2026. Final date, time, and location decided by nolo, odalys, polo, etc.",
    ...
    "title": "launch",
    "color": "forest",
    "symbol": "four sine-like launch waves from left to right: a nearly flat ripple, a small rise and fall, another nearly flat ripple, then a steep rise and fall",
    "cover": "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"3\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M 12 76 C 14 76 15 75 18.5 75 C 22 75 23 76 25 76\"/><path d=\"M 33 76 C 36 76 36 70 39.5 70 C 43 70 43 76 46 76\"/><path d=\"M 54 76 C 56 76 57 75 60.5 75 C 64 75 65 76 67 76\"/><path d=\"M 75 76 C 78 76 78 24 81.5 24 C 85 24 85 76 88 76\"/></svg>",
    "shelf": "trailblazer special",
    "priceUsd": 175,
    "fulfillment": "pickup"
  },
  {
